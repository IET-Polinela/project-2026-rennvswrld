...
const routes = {
    ...
    // 📊 2. TEMPLATE HALAMAN DASHBOARD (LAYOUT KEMBAR MILIK DOSEN - 2 KOLOM)
    '#dashboard': `
        <div class="row g-4 animate-fade-in">
            
            <aside class="col-12 col-lg-3">
                <div class="card border-0 shadow-sm mb-4 rounded-3" style="background-color: transparent;">
                    <button onclick="openNewReportModal()" class="btn btn-primary btn-lg w-100 fw-bold py-4 rounded-3 d-flex flex-column align-items-center justify-content-center gap-2 shadow-sm" style="font-size: 1.15rem; min-height: 140px;">
            ...
            <section class="col-12 col-lg-9">
                <ul class="nav nav-tabs mb-4 border-bottom-0 gap-2" id="dashboardTabs" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link text-secondary fw-bold border-0 bg-transparent px-4 py-2" id="tab-my_reports" onclick="switchTab('my_reports')">
                            <i class="bi bi-folder-fill me-2"></i>Laporan Saya
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link text-secondary fw-bold border-0 bg-transparent px-4 py-2" id="tab-feed" onclick="switchTab('feed')">
